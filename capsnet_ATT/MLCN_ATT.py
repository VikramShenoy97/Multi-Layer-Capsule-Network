...
class CapsuleNetwork(nn.Module):
  ...
  def forward(self, x, y=None, pose=False):
    ...
    class_Scores = torch.unsqueeze(class_scores, 0)
    # print(class_scores.shape)
    # Shape of class_scores = [128 x 10]
    class_probabilities = F.softmax(class_scores)
    class_probabilities = torch.unsqueeze(class_probabilities, 0)
    # print("Class Probabilities: ", class_probabilities.shape)
