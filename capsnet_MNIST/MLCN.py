...
class CapsuleNetwork(nn.Module):
  def __init__(self):
    ...
    self.capslayertwo = IntermediateCapsLayer(num_capsules=20, routing_nodes=32*6*6, in_channels=8, out_channels=12)
    self.capslayerthree = IntermediateCapsLayer(num_capsules=10, routing_nodes=20, in_channels=12, out_channels=16)
  ...
  def forward(self, x, y=None, pose=False, encodings=False):
    # Encoder Network
